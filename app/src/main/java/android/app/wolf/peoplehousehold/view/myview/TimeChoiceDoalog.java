 ...
 * 修改记录：
 */
public class TimeChoiceDoalog extends Dialog {
    ...
    public TimeChoiceDoalog(Context context) {
        super(context, R.style.dialog_notice);
        this.context = context;
    }

    public TimeChoiceDoalog setOnCancelListener(String cancelText,OnCancelinterface onCancelinterface){
        this.cancelText = cancelText;
        this.onCancelinterface = onCancelinterface;
        return this;
    }

    public TimeChoiceDoalog setOnConfirmListener(String confirmText,OnConfirminterface onConfirminterface){
    ...
    private void init() {
        ...
        View view = inflater.inflate(R.layout.dialog_timechoice, null);
        setContentView(view);
        setCancelable(false);
        ...
        dialog_time_yearPick.setMinValue(2010);
        dialog_time_yearPick.setMaxValue(2030);
